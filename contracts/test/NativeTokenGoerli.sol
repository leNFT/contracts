...
import {TrustusUpgradable} from "../protocol/Trustus/TrustusUpgradable.sol";
import {ContextUpgradeable} from "@openzeppelin/contracts-upgradeable/utils/ContextUpgradeable.sol";
import {DataTypes} from "../libraries/types/DataTypes.sol";
import {Time} from "../libraries/Time.sol";

// Goerli testnet native token allows minting by anyone
contract NativeTokenGoerli is
    Initializable,
    ContextUpgradeable,
    INativeToken,
    ERC20Upgradeable,
    ...
    TrustusUpgradable
{
    ...
    function mint(address account, uint256 amount) external {
        require(amount <= 10000 * 1e18, "MAX MINT IS 10000");
